    ...
    <div class="peers ai-s fxw-nw h-100vh">
        <div class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv"
            ...
            <div class="pos-a centerXY">
                <!-- ======= Background overlap logo hide with white background ========
                <div class="bgc-white bdrs-50p pos-r" style='width: 120px; height: 120px;'>
                    <img class="pos-a centerXY w-100 p-20" src="{{asset('images/cropped-logo-4-192x192.png')}}" alt="">
                </div> -->
            </div>
        </div>
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <div class="peers ai-c jc-sb fxw-nw">
                        ...
                        <div class="peer">
                            <button class="btn btn-primary"><b><i class="ti-lock mR-10"></i>Login</b></button>
                        </div>
                    </div>
                </div>
            </form>
