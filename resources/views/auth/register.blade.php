            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register.user.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-md-4 col-form-label text-md-right">{{ __('Give a Title of your') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-md-4 col-form-label text-md-right">{{ __('Give a description of your') }}</label>
